...
1.  Click **Next**.
    ...
    ![](/blog/oidc_client_creation/2023-07-06/general-settings.png)
...
1.  Click **Next**.
    ...
    ![](/blog/oidc_client_creation/2023-07-06/capability-config.png)
...
1.  Click **Save**
    ...
    ![](/blog/oidc_client_creation/2023-07-06/login-settings.png)
...
1. Select **Keycloak OIDC JSON** in the format option. The details section will populate with the details we will need.
   ...
   ![](/blog/oidc_client_creation/2023-07-06/adapter-config.png)
