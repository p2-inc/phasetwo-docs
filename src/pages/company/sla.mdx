...
We guarantee at least 99.5% availability on Premium plans and 99.95% on Enterprise plans. Starter clusters target 95% availability on a best-effort basis; Phase Two makes no availability commitment for Starter clusters and they are not eligible for the service credits described below. In case of an outage larger than that occurring during more than one day (24 hours), Phase Two will provide the Customer with service credits equaling an amount of 50% of the monthly equivalent instance’s subscription cost for all outages during a calendar month. Service credits will be calculated in accordance with the following formula :
...
_SLA Last updated: February, 2026_
