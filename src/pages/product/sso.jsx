...
function SSO() {
  return (
    <Layout
      title="SSO"
      description="Single Sign-On for SAML, OIDC, and most Identity vendors"
    >
      <main>
        {/* Hero */}
        <div className={`pageHero`}>
          ...
          <div className={`pageHeroMsg`}>
            ...
            <p className={`pageHeroMsgIntro`}>
              Support SSO with the most popular identity providers with just a
              few lines of code. 5 minutes to enable a universal login flow for
        ...
        <div className={`contentBlock`}>
          <div className={`contentBlockHead`}>
            ...
            <p>
              ...
              engagement, lower friction, and better retention.
            </p>
          </div>
        ...
        <div className={`contentBlock`}>
          ...
          <div className={`contentBlockHead`}>
            ...
            <p>
              We support dozens of popular identity providers, and provide
            ...
            <a href="#" className={`readMore`}>
              ...
              <div className={`readMoreR`}>
                ...
                <p>
                  ...
                  Quickly deliver a solution to the enterprise fragmentation
                  problem, and immediately provide increased security,
                  productivity and adoption. Read more about why you should
                  begin now.
                </p>
