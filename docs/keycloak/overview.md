...
JWT's are a subject unto themselves. See our articles on [JWTs](/tutorials/jwts/), or paste a token into our free [JWT Decoder](/tools/jwt-decoder) to inspect its claims, roles, and scopes.
