...
Phase Two provides built-in observability for dedicated clusters through the self-service dashboard, split into two areas:
...
- **[Telemetry Export](./telemetry-export.md)** — stream the same logs and events to your own observability system over OTLP. Experimental.
...
> Looking for the old combined Observability tab? It has been split into the dedicated **Metrics** and **Logs** sections linked above.
