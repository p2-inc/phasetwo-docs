...
author: Phase Two
tags: [phase_two, tutorial, frameworks, nextjs, react, reactjs]
---
...
If you just want to skip to the code, visit the Phase Two [Next.js example](https://github.com/p2-inc/examples/tree/main/frameworks/nextjs). We also have a plain [React example](https://phasetwo.io/blog/https://phasetwo.io/blog/instant-user-managemenet-and-sso-for-reactjs).
